...
.WithDescription("Looks up coordinates for the given city and retrieves the weather forecast from the National Weather Service API. Results are cached for 15 minutes.")
